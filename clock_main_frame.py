#!/usr/bin/env python3
"""Clock_main_frame: 99% autogenerated from wxGlade GUI GUI creator."""

# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.4 on Thu Mar  2 16:21:04 2023
#
...
class RoundTimer(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        sizer_1.Add(self.label_round, 1, wx.EXPAND, 0)
        ...
        sizer_1.Add(self.label_clock, 8, wx.EXPAND, 0)
        ...
        self.button_reset = wx.Button(self.panel_1, wx.ID_ANY, "Restart")
...
class SetupDialog(wx.Dialog):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.Bind(wx.EVT_TEXT, self.on_round_count_change, self.text_round_count)
        self.Bind(wx.EVT_TEXT, self.on_round_length_change, self.text_round_length)
        self.Bind(wx.EVT_TEXT, self.on_break_rounds_change, self.text_break_rounds)
        self.Bind(wx.EVT_TEXT, self.on_break_length_change, self.text_break_length)
        self.Bind(wx.EVT_CHECKBOX, self.on_restart_checked, self.check_restart)
        # end wxGlade

    def on_round_count_change(self, event):  # wxGlade: SetupDialog.<event_handler>
        """Text entry callback stub - override in classes that inherit."""
        print("Event handler 'on_round_count_change' implemented!")
        if self.text_round_count.GetValidator().Validate(self):
            self.text_round_count.SetBackgroundColour("#ff0000")
        event.Skip()

    def on_round_length_change(self, event):  # wxGlade: SetupDialog.<event_handler>
        """Text entry callback stub - override in classes that inherit."""
        print("Event handler 'on_round_length_change' not implemented!")
        event.Skip()

    def on_break_rounds_change(self, event):  # wxGlade: SetupDialog.<event_handler>
        """Text entry callback stub - override in classes that inherit."""
        print("Event handler 'on_break_rounds_change' not implemented!")
        event.Skip()

    def on_break_length_change(self, event):  # wxGlade: SetupDialog.<event_handler>
        """Text entry callback stub - override in classes that inherit."""
        print("Event handler 'on_break_length_change' not implemented!")
        event.Skip()
