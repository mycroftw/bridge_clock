#!/usr/bin/env python3
"""Clock_main_frame: 99% autogenerated from wxGlade GUI creator."""

# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.5 on Sat Oct 19 13:14:05 2024
#
...
class RoundTimer(wx.Frame):
    """The timer box.  Contains Round number, clock, buttons and statusbar.

    Because this is auto-generated by wxGlade, want to minimize changes here
    to facilitate importing of changes made in wxGlade.  The real program
    should have a class that inherits this and puts in all the "work".
    """

    def __init__(self, *args, **kwds):  # pylint: disable=too-many-statements
        ...
        item = wxglade_tmp_menu.Append(wx.ID_ANY, "Save Current Profile\tCtrl-S", "")
        self.Bind(wx.EVT_MENU, self.on_menu_file_save, item)
        item = wxglade_tmp_menu.Append(wx.ID_ANY, "Load Profile\tCtrl-L", "")
        self.Bind(wx.EVT_MENU, self.on_menu_file_load, item)
        item = wxglade_tmp_menu.Append(wx.ID_ANY, "Exit\tCtrl-X", "")
        self.Bind(wx.EVT_MENU, self.on_menu_file_exit, item)
        self.frame_menubar.Append(wxglade_tmp_menu, "&File")
        wxglade_tmp_menu = wx.Menu()
        item = wxglade_tmp_menu.Append(wx.ID_ANY, "Parameters\tCtrl-P", "")
        ...
        for i, field in enumerate(frame_statusbar_fields):
            self.frame_statusbar.SetStatusText(field, i)

        self.panel_1 = wx.Panel(
            self, wx.ID_ANY, style=wx.CLIP_CHILDREN | wx.FULL_REPAINT_ON_RESIZE
        )
        ...
        self.label_description.SetBackgroundColour(wx.Colour(176, 0, 255))
        self.label_description.SetForegroundColour(wx.Colour(255, 255, 0))
        self.label_description.SetFont(
            wx.Font(
                36,
                wx.FONTFAMILY_SWISS,
                wx.FONTSTYLE_NORMAL,
        ...
        self.sizer_1.Add(self.label_description, 1, wx.EXPAND, 0)
        ...
        self.sizer_1.Add(self.sizer_clock, 5, wx.EXPAND, 0)
        ...
        self.sizer_clock.Add(self.label_clock_minutes, 4, wx.EXPAND, 0)

        self.label_clock_colon = wx.StaticText(
            self.panel_1,
            wx.ID_ANY,
            ":",
            style=wx.ALIGN_CENTER_HORIZONTAL | wx.ST_NO_AUTORESIZE,
        ...
        self.sizer_clock.Add(self.label_clock_colon, 1, wx.EXPAND, 0)
        ...
        self.sizer_clock.Add(self.label_clock_seconds, 4, wx.EXPAND, 0)
    ...
    def on_menu_file_save(self, event):  # wxGlade: RoundTimer.<event_handler>
        """Menu button callback stub - override in classes that inherit."""
    ...
    def on_context_menu(self, event):  # wxGlade: RoundTimer.<event_handler>
        """Context Menu callback stub - override in classes that inherit."""
        print("Event handler 'on_context_menu' not implemented!")
        event.Skip()

    def on_button_start(self, event):  # wxGlade: RoundTimer.<event_handler>
        """Button callback stub - override in classes that inherit."""
    ...
    def on_close(self, event):  # wxGlade: RoundTimer.<event_handler>
        """Close frame callback stub - override in classes that inherit."""
        print("Event handler 'on_close' not implemented!")
        event.Skip()

    def on_resize(self, event):  # wxGlade: RoundTimer.<event_handler>
        """Resize callback stub - override in classes that inherit."""
...
class SetupDialog(wx.Dialog):  # pylint: disable=too-few-public-methods
    """User review and input/change of game settings dialog box.
    ...
    def __init__(self, *args, **kwds):
        ...
        self.text_break_rounds.SetToolTip(
            "Rounds to give a break after.  "
            "If more than one, separate by commas (e.g. 4, 9)"
        )
        ...
        self.check_invisible.SetToolTip(
            "If checked, "
            "rather than showing a break explicitly, "
            "just add the time to the current round."
        )
        ...
        self.check_show_description = wx.CheckBox(
            self.panel_1, wx.ID_ANY, 'Description (e.g. "Sections KLM"):'
        )
        sizer_5.Add(self.check_show_description, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.text_description = wx.TextCtrl(self.panel_1, wx.ID_ANY, "")
        self.text_description.SetToolTip(
            "If needed, one-line description of who this clock is for."
        )
        sizer_5.Add(self.text_description, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        self.Bind(
            wx.EVT_CHECKBOX, self.on_description_checked, self.check_show_description
        )
        self.Bind(wx.EVT_CHECKBOX, self.on_restart_checked, self.check_restart)
        # end wxGlade

    def on_description_checked(self, event):  # wxGlade: SetupDialog.<event_handler>
        """Checkbox callback stub - override in classes that inherit."""
        print("Event handler 'on_description_checked' not implemented!")
        event.Skip()
...
class MyApp(wx.App):
    """Run the (bare) app.  Never should be called."""
