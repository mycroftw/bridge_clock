...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.5 on Sat Oct 19 13:15:53 2024
#
...
class RoundTimer(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu = wx.Menu()
        self.frame_menubar.i_view_buttons = wxglade_tmp_menu.Append(wx.ID_ANY, "Hide_Buttons", "", wx.ITEM_CHECK)
        self.Bind(wx.EVT_MENU, self.on_menu_view_buttons, self.frame_menubar.i_view_buttons)
        self.frame_menubar.i_view_statusbar = wxglade_tmp_menu.Append(wx.ID_ANY, "Hide Statusbar", "", wx.ITEM_CHECK)
        ...
        self.panel_1 = wx.Panel(self, wx.ID_ANY, style=wx.CLIP_CHILDREN | wx.FULL_REPAINT_ON_RESIZE)

        self.sizer_1 = wx.BoxSizer(wx.VERTICAL)

        self.label_description = wx.StaticText(self.panel_1, wx.ID_ANY, "All Sections", style=wx.ALIGN_CENTER_HORIZONTAL | wx.ST_NO_AUTORESIZE)
        ...
        self.label_description.SetFont(wx.Font(36, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, "Copperplate Gothic Bold"))
        self.sizer_1.Add(self.label_description, 1, wx.EXPAND, 0)

        self.label_round = wx.StaticText(self.panel_1, wx.ID_ANY, "Round 1", style=wx.ALIGN_CENTER_HORIZONTAL | wx.ST_NO_AUTORESIZE)
        ...
        self.label_clock_minutes = wx.StaticText(self.panel_1, wx.ID_ANY, "15", style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE)
        ...
        self.label_clock_minutes.SetFont(wx.Font(256, wx.FONTFAMILY_ROMAN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
        self.sizer_clock.Add(self.label_clock_minutes, 4, wx.EXPAND, 0)

        self.label_clock_colon = wx.StaticText(self.panel_1, wx.ID_ANY, ":", style=wx.ALIGN_CENTER_HORIZONTAL | wx.ST_NO_AUTORESIZE)
        ...
        self.label_clock_colon.SetFont(wx.Font(256, wx.FONTFAMILY_ROMAN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
        self.sizer_clock.Add(self.label_clock_colon, 1, wx.EXPAND, 0)

        self.label_clock_seconds = wx.StaticText(self.panel_1, wx.ID_ANY, "00", style=wx.ALIGN_LEFT | wx.ST_NO_AUTORESIZE)
        ...
        self.label_clock_seconds.SetFont(wx.Font(256, wx.FONTFAMILY_ROMAN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
...
class SetupDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.check_show_description = wx.CheckBox(self.panel_1, wx.ID_ANY, "Description (e.g. \"Sections KLM\"):")
        ...
        self.text_description.SetToolTip("If needed, one-line description of who this clock is for.")
        ...
        self.Bind(wx.EVT_CHECKBOX, self.on_description_checked, self.check_show_description)
